      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 start-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white dark:bg-slate-900 rounded-[24px] shadow-2xl z-[101] overflow-hidden border border-slate-100 dark:border-slate-800"
          >
            {isSuccess ? (
