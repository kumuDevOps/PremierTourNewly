          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-start">
              ...
              <div className="relative">
                <Mail className="absolute start-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-400" />
                <input
                  id="login-email"
                  type="email"
                  required
                  ...
                  className="w-full ps-11 pe-4 py-3 border border-slate-250 rounded-xl text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0091EA] focus:border-transparent transition-all"
                />
              </div>
            </div>
            ...
            <div className="text-start">
              ...
              <div className="relative">
                <Lock className="absolute start-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-400" />
                <input
                  id="login-password"
                  ...
                  className="w-full ps-11 pe-11 py-3 border border-slate-250 rounded-xl text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0091EA] focus:border-transparent transition-all"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute end-3.5 top-1/2 -translate-y-1/2 p-1 rounded-md text-slate-400 hover:text-slate-600 focus:outline-none"
            ...
            <div className="flex items-center text-start">
              ...
              />
              <label htmlFor="login-remember-me" className="ms-2.5 text-xs font-semibold text-slate-600 select-none cursor-pointer">
